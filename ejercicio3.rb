...
# Crear un método de instancia llamado play que
# reciba como argumento un número al cual se está
# apostando. Luego debe tomar un valor -del array- al
...
# Crear un método que lea el archivo rouletter_history.txt y retorne
# el valor que más ha generado la ruleta históricamente.
def Roulette
  @play
end
